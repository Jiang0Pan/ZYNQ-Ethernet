...
#define     R_MB_FIRMWARE       (0xACCD)   //NOT USED
...
/* Receive Pattern Start Address */
#define     PATTERN_START_ADDR  (0x30000000)
/*  Receive Pattern End Address */
#define     PATTERN_END_ADDR    (0x3FFFFFFF)
