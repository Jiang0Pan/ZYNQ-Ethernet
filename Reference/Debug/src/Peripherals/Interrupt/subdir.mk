...
C_SRCS += \
../src/Peripherals/Interrupt/Interrupt.c 

OBJS += \
./src/Peripherals/Interrupt/Interrupt.o 

C_DEPS += \
./src/Peripherals/Interrupt/Interrupt.d 


# Each subdirectory must supply rules for building sources it contributes
src/Peripherals/Interrupt/%.o: ../src/Peripherals/Interrupt/%.c
	@echo 'Building file: $<'
